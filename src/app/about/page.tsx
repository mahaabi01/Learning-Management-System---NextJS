    ...
    <div className="sm:flex items-center max-w-screen-xl">
      <div className="sm:w-1/2 p-10">
        <div className="image object-center text-center">
          <Image alt="image" src="https://i.imgur.com/WbQnbas.png" />
        </div>
      </div>
      <div className="sm:w-1/2 p-5">
        <div className="text">
          ...
          <p className="text-gray-700">
            ...
            lessons, and student progress. Teachers can create and sell their
            courses, while students can easily access, track, and complete their
            learning materials. With a focus on performance, security, and
            scalability, our LMS aims to enhance online education and make
